...
class LeaderboardEvaluator(object):
    ...
    def _setup_simulation(self, args):
        ...
        if args.start_carla is not False:
...
def main():
    ...
    parser.add_argument('--start-carla', type=bool, default=True, 
                        help='Start a new CARLA server? If False, assume that a CARLA server is already running at --host and --port')
